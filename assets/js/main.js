...
(function () {
  ...
  var I18N = {
    zh: {
      ...
      "doc.desc":
        "AlgoSoft 旗下产品：AlgoCOM、AlgoTerm、AlgoGit、AlgoPDF、AlgoCode 与 AlgoClass。原 augur 系列产品已全新升级为 Algo 品牌。",
      "nav.products": "产品",
      "nav.rebrand": "更名公告",
      "nav.brand": "关于",
      "nav.cta": "开始探索",
      ...
      "hero.title2": "算法级工具家族",
      "hero.subtitle":
        "六款精心打磨的工具，覆盖串口通信、终端、版本控制、文档处理、代码编辑与编程教学。一样的匠心，全新的 Algo 品牌。",
      "hero.cta1": "浏览产品",
      "hero.cta2": "了解 AlgoSoft",
      "rebrand.title": "品牌升级：Augur → Algo",
      "rebrand.desc":
        "augur 系列产品自即日起统一更名为 Algo 系列。产品功能与后续更新不受影响，感谢一路相伴。",
      "products.kicker": "产品矩阵",
      "products.title": "六款工具，一个家族",
      "products.subtitle": "每一款都围绕真实开发场景反复打磨，轻量、快速、可靠。",
      "product.com.oldName": "原 augur-com",
      ...
      "product.term.oldName": "原 augur-term",
      ...
      "product.git.oldName": "原 augur-git",
      ...
      "product.pdf.oldName": "原 augur-pdf",
    ...
    en: {
      ...
      "doc.desc":
        "Products by AlgoSoft: AlgoCOM, AlgoTerm, AlgoGit, AlgoPDF, AlgoCode and AlgoClass. The former augur series has been fully rebranded to Algo.",
      "nav.products": "Products",
      "nav.rebrand": "Rebranding",
      "nav.brand": "About",
      "nav.cta": "Get Started",
      ...
      "hero.subtitle":
        "Six carefully crafted tools covering serial communication, terminal, version control, documents, code editing and coding education. Same craftsmanship, brand new Algo identity.",
      "hero.cta1": "Explore Products",
      "hero.cta2": "About AlgoSoft",
      "rebrand.title": "Rebranding: Augur → Algo",
      "rebrand.desc":
        "The augur product series has been renamed to the Algo series. Features and future updates are unaffected — thank you for being with us.",
      ...
      "product.com.oldName": "formerly augur-com",
      ...
      "product.term.oldName": "formerly augur-term",
      ...
      "product.git.oldName": "formerly augur-git",
      ...
      "product.pdf.oldName": "formerly augur-pdf",
