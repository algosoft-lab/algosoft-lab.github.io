  ...
  features: {
    ...
    items: [
      ...
      },
      {
        title: '双页视图',
        description:
          '当前页与下一页并排显示，讲解时永远先看一步，不再翻页翻到手忙脚乱。',
        accent: 'blue',
      },
      {
        title: '缩略图视图',
        description:
          '右侧滚动预览全部页面，进度与节奏一目了然，随时跳转到任意一页。',
        accent: 'emerald',
      },
      {
        title: '画笔批注',
      ...
      },
      {
        title: '流畅渲染',
        description:
          'hayro 渲染引擎配合预渲染队列，快速翻页不白屏、不卡顿，大文件同样顺滑。',
        accent: 'cyan',
      },
      {
        title: '中英双语',
        description:
          '界面跟随系统语言，也可以在「关于」中一键切换中文 / English。',
        accent: 'orange',
      },
    ],
  },
...
const enContent: PdfPageContent = {
  ...
  features: {
    ...
    subtitle:
      'From page turns to annotations, every detail serves the person at the front of the room.',
    items: [
      {
  ...
  cta: {
    ...
    subtitle:
      'Get AlgoPDF from the Microsoft Store and hand your next talk over to it.',
    action: 'Get AlgoPDF',
    actionUrl: PDF_STORE_URL,
  },
  footer: {
